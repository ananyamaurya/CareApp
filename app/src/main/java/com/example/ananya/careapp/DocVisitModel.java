...
public class DocVisitModel {
    ...
    public DocVisitModel(){

    }
    public DocVisitModel(String ID, String time, String prescription, String doctor, String condition, String disease){
        uID=ID;
        utime=time;
