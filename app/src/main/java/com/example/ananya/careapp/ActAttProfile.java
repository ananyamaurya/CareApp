...
public class ActAttProfile extends Activity {
    CircleImageView imageUpload;
    EditText ename,eage,emobile;
    Spinner egender,ehos,ecity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_att_profile);
        database =FirebaseDatabase.getInstance();
        ref = database.getReference("hospitals");
        pickimage = findViewById(R.id.actattprofedit);
        savepro = findViewById(R.id.actattprofsave);
        egender = findViewById(R.id.actattprofgenderspin);
        ehos = findViewById(R.id.actattprofilehosspin);
        ecity = findViewById(R.id.actattprofilecityspin);
        ename = findViewById(R.id.actattprofname);
        eage = findViewById(R.id.actattprofage);
        imageUpload =findViewById(R.id.actattimageUpload);
        emobile = findViewById(R.id.actattprofilemob);
